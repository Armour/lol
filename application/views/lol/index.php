			...
			<div id="skin-frame">
				...
				<div class="skin-box" id="boxl">
					<img class="skin-cover" src="{skin_image}" alt="{skin_name}/{skin_designer}">
				...
				<div class="skin-box" id="boxm">
					<img class="skin-cover" src="{skin_image}" alt="{skin_name}/{skin_designer}/{skin_vote_number}">
					<div class="skin-border"></div>
					<p class="skin-name">{skin_name}</p>
					<p class="skin-author">作者：{skin_designer}</p>
					<p class="skin-votes">当前得票：{skin_vote_number}</p>
			...
			<div id="voice-frame">
				...
				<div class="voice-box" id="box1">
					<img class="voice-cover" src="{voice_image}" alt="{voice_name}/{voice_designer}/{voice_vote_number}"> <div class="voice-border"></div>
					...
					<form method="post" accept-charset="utf-8" action="vote/index/vote_voice/{voice_id}">
				...
				<div class="voice-box" id="box2">
					<img class="voice-cover" src="{voice_image}" alt="{voice_name}/{voice_designer}/{voice_vote_number}">
